...
class EmailService:
    ...
    def send_otp_email(self, to_email: str, to_name: str, otp: str, purpose: str = "password_reset") -> bool:
        """
        ...
        try:
            ...
            # Create email client
            mailer = Email.NewEmail(self.api_key)
            ...
            if purpose == "password_reset":
                ...
                html_content = self._get_password_reset_template(to_name, otp)
                text_content = f"Your password reset OTP is: {otp}. This code expires in 15 minutes."
            else:
                subject = "Verify Your RomaSub.AI Email"
                html_content = self._get_email_verify_template(to_name, otp)
    ...
    def _get_password_reset_template(self, name: str, otp: str) -> str:
    ...
    def _get_email_verify_template(self, name: str, otp: str) -> str:
